...
import { LayoutDashboard, Calendar, BookOpen, MessageSquare, BarChart2, Users, Settings, LogOut, Activity, Heart, Shield, Star, Image as ImageIcon } from 'lucide-react';
...
const Layout = () => {
  ...
  return (
    <div className="flex h-screen bg-[var(--color-bg-primary)] text-[var(--color-text-primary)] font-sans overflow-hidden transition-colors duration-500">
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-y-auto relative rounded-l-3xl my-4 mr-4 bg-[var(--color-bg-primary)] flex flex-col">
        ...
        <AnimatePresence>
          {showUINotification && (
            <motion.div
              ...
              className="m-4 md:m-8 mb-0 p-4 rounded-2xl bg-gradient-to-r from-[var(--color-pastel-purple)] to-[var(--color-pastel-blue)] text-white soft-shadow flex items-center justify-between"
            >
