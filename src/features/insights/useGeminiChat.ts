...
export type ChatMode = 'vent' | 'reflection' | 'cbt' | 'grounding';
...
const SYSTEM_INSTRUCTIONS: Record<ChatMode, string> = {
  ...
  reflection: "You are a reflection coach. Ask clarifying questions to help the user understand their emotions better. Guide them to deeper insights.",
